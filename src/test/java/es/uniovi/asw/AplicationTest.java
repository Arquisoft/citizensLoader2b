...
public class AplicationTest {
	...
	public void testCargarCiudadanos(){
		// leemos  y cargamos el fichero
		Xlsx x = new Xlsx();
		List<Ciudadano> ciudadanos = x.leerCiudadanos(new ArrayList<Ciudadano>(), "./src/test/java/es/uniovi/asw/test.xlsx");
	...
	public void testCrearCorreo(){
		Ciudadano c = new Ciudadano("Marcos", "Garcia", "marcos@mail.com", "C/ peru 3", "Español", "87963215P", new Date(1990-1900,2,10));
		c.crearPassword();
